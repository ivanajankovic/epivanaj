				...
				<div class='col-md-4'>
							<div class='panel panel-info'>
								...
								<div class='panel-body'>
									<img src='admin/product_images/$pro_image' style='width:160px; height:250px;'/>
								</div>
	...
	if($count > 0){
		...
		while($row=mysqli_fetch_array($run_query)){
			...
			if(isset($_POST["get_cart_product"])){
				...
				<div class='row'>
					...
					<div class='col-md-3 col-xs-3'><img src='admin/product_images/$pro_image' width='60px' height='50px'></div>
			...
			$no = $no + 1;
				...
				echo "
					<div class='row'>
							...
							<div class='col-md-2 col-sm-2'><img src='admin/product_images/$pro_image' width='50px' height='60'></div>
		...
		echo '
				...
				<form action="https://www.sandbox.paypal.com/cgi-bin/webscr" method="post">
				  ...
				  <input type="hidden" name="business" value="shoppingcart@epstore.com">
